...
- Location: tests/ui.spec.js:45:5
...
> 56 |     expect(page.locator('.v-snack__content')).toContainText('Вы добавили канал. На нем автоматически включился автоответ: «Первое входящее»');
     |                                               ^ Error: expect(locator).toContainText(expected) failed
  57 | 
  58 |     
  59 | });
