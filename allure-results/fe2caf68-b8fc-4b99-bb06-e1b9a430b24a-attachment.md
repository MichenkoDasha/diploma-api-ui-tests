...
```
Error: locator.click: Error: strict mode violation: getByRole('link').filter({ hasText: /^$/ }) resolved to 2 elements:
    1) <a data-v-13751a9a="" href="/5519-6352/settings/channels/2e3bdfda-0e74-40a0-85cd-229a3b228811" class="v-btn v-btn--icon v-theme--light v-btn--density-default v-btn--size-default v-btn--variant-flat">…</a> aka getByRole('link').filter({ hasText: /^$/ }).first()
    2) <a data-v-13751a9a="" href="/5519-6352/settings/channels/e10dcaf7-c218-4f94-9b30-98318f82a4bc" class="v-btn v-btn--icon v-theme--light v-btn--density-default v-btn--size-default v-btn--variant-flat">…</a> aka getByRole('link').filter({ hasText: /^$/ }).nth(1)
        ...
        - generic [ref=e108]:
          ...
          - generic [ref=e116]:
            ...
            - link [ref=e130] [cursor=pointer]:
              - /url: /5519-6352/settings/channels/2e3bdfda-0e74-40a0-85cd-229a3b228811
              - generic [ref=e132]: 󱕷
          - generic [ref=e133]:
            - generic [ref=e134]:
              - img [ref=e136]
              - generic "TetrisMyNewTestQuruBot" [ref=e138]
            - generic [ref=e139]:
              - generic:
                - generic: Активен
              - button "󰘥" [ref=e141] [cursor=pointer]
            - generic [ref=e145]: Тестовый период:3 дня
            - link [ref=e147] [cursor=pointer]:
              - /url: /5519-6352/settings/channels/e10dcaf7-c218-4f94-9b30-98318f82a4bc
              - generic [ref=e149]: 󱕷
  - generic:
    - tooltip
    - tooltip
