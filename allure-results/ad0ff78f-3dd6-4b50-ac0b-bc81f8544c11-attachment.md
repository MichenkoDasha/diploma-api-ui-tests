...
```
Error: locator.click: Error: strict mode violation: locator('div').filter({ hasText: /Telegram/ }) resolved to 10 elements:
    1) <div id="__nuxt" data-v-app="">…</div> aka locator('[id="__nuxt"]')
    2) <div class="main" data-v-dfb8f915="">…</div> aka locator('div').nth(1)
    3) <div data-v-8b3cea63="" data-v-dfb8f915="" class="v-application v-theme--light v-layout v-layout--full-height v-locale--is-ltr settings-layout">…</div> aka locator('div').nth(2)
    4) <div class="v-application__wrap">…</div> aka locator('div').nth(3)
    5) <div data-v-8b3cea63="" class="main-content">…</div> aka locator('div').filter({ hasText: 'Добавьте каналКанал — это аккаунт в мессенджере или соцсети, который вы подключа' }).nth(4)
    6) <div data-v-dc31ffbf="" data-v-8b3cea63="" class="channels-page">…</div> aka locator('div').filter({ hasText: 'Добавьте каналКанал — это аккаунт в мессенджере или соцсети, который вы подключа' }).nth(5)
    7) <div data-v-bbf26368="" data-v-dc31ffbf="" class="channels-no-channels-adding-grid">…</div> aka locator('.channels-no-channels-adding-grid')
    8) <div data-v-bbf26368="" class="adding-grid-container">…</div> aka getByText('Добавьте каналКанал — это аккаунт в мессенджере или соцсети, который вы подключа')
    9) <div data-v-8531f745="" data-v-bbf26368="" class="channels-grid-tabs">…</div> aka getByText('MAXWhatsAppInstagramTelegram')
    10) <div data-v-8531f745="" class="channel-card">…</div> aka locator('div').filter({ hasText: /^Telegram Personal$/ })

Call log:
  - waiting for locator('div').filter({ hasText: /Telegram/ })
...
```ts
  ...
  2  |     constructor(page) {
  3  |         this.page = page;
  4  |         this.channel = page.locator('div').filter({ hasText: /Telegram/ });
