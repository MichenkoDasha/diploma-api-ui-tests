...
- generic [ref=e5]:
  ...
  - main [ref=e129]:
    - generic [ref=e133]:
      ...
      - generic [ref=e171]:
        - generic [ref=e172]:
          - button "Могу ли я сам создавать теги, прям вот сам?" [expanded] [ref=e173] [cursor=pointer]:
            - generic [ref=e174]: Могу ли я сам создавать теги, прям вот сам?
            - img [ref=e177]
          - generic [ref=e181]: Да, вы можете создавать теги для шаблонов. Когда вы создаете или редактируете шаблон, можно добавить теги, которые помогут быстро найти нужные шаблоны в чатах. Вы можете создать свои собственные теги для удобной фильтрации.
        - button "Что будет, если я создам новый шаблон?" [ref=e183] [cursor=pointer]:
          - generic [ref=e184]: Что будет, если я создам новый шаблон?
          - img [ref=e187]
        - button "Сколько всего шаблонов я могу создать?" [ref=e190] [cursor=pointer]:
          - generic [ref=e191]: Сколько всего шаблонов я могу создать?
          - img [ref=e194]
      - button "Попробовать" [ref=e196] [cursor=pointer]:
        - generic [ref=e197]: Попробовать
  - generic [ref=e198]:
    - generic [ref=e199]:
      - generic [ref=e200]: Мы всегда на связи ❤️
      - generic [ref=e201]: Наша поддержка работает 24/7 и отвечает за 5 минут. Пишите нам в любое время — поможем со сложными и простыми вопросами.
    - generic [ref=e202]:
      - button "Контакты поддержки" [ref=e204] [cursor=pointer]:
        - generic [ref=e205]: Контакты поддержки
      - button "Закрыть" [ref=e207] [cursor=pointer]:
        - generic [ref=e208]: Закрыть
```
