...
Locator: getByRole('heading', { name: 'Добавьте канал' })
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByRole('heading', { name: 'Добавьте канал' })
...
> 70 |     expect(page.getByRole('heading', { name: 'Добавьте канал' })).toBeVisible();
     |                                                                   ^ Error: expect(locator).toBeVisible() failed
  71 | });
```