...
Call log:
  - waiting for getByRole('link', { name: 'Каналы' })
    - locator resolved to <a role="link" tabindex="-2" data-v-9865465b="" aria-current="page" aria-describedby="v-tooltip-v-1-3" href="/1798-9091/settings/channels" class="v-list-item v-list-item--active v-list-item--link v-list-item--nav v-theme--light text-green v-list-item--density-compact v-list-item--one-line v-list-item--rounded v-list-item--variant-text list-item">…</a>
      ...
      - generic [ref=e103]:
        ...
        - generic [ref=e108]:
          ...
          - generic [ref=e116]:
            ...
            - generic [ref=e130]: Тестовый период:14:48
...
```ts
  ...
  11 | 
  12 |     async open() {
  13 |         await this.akk.click({ force: true });
  14 |     }
  15 | 
